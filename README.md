...
<p align="center">
  ...
  <a href="docs/errors_log.md"><strong> 63 Pitfalls Checklist</strong></a> •
...
* **The 63 Pitfalls Checklist**: Before trying this on another model, check [`docs/errors_log.md`](docs/errors_log.md) — it documents 63 real measurement mistakes made during this work that gave plausible-looking numbers but were totally wrong.
