...
<p align="center">
  ...
  <a href="docs/errors_log.md"><strong> 61 Pitfalls Checklist</strong></a> •
...
* **The 61 Pitfalls Checklist**: Before trying this on another model, check [`docs/errors_log.md`](docs/errors_log.md) — it documents 61 real measurement mistakes made during this work that gave plausible-looking numbers but were totally wrong.
